# Contributing to @dhealth/hd-wallets

First off, thank you for considering contributing to @dhealth/hd-wallets. 
It’s people like you that make @dhealth/hd-wallets such a great tool.

@dhealth/hd-wallets is an open source project and we love to receive contributions from 
...
writing code which can be incorporated into @dhealth/hd-wallets itself.
...
If you think you have found a bug in @dhealth/hd-wallets, first make sure that you 
are testing against the latest version of @dhealth/hd-wallets - your issue may already 
...
If you find yourself wishing for a feature that doesn't exist in @dhealth/hd-wallets, 
you are probably not alone. There are bound to be others out there with similar 
needs. Many of the features that @dhealth/hd-wallets has today have been added because 
our users saw the need. Open an [issue](github-issues) on our issues list on GitHub which describes 
the feature you would like to see, why you need it, and how it should work.

## Contributing code and documentation changes

If you have a bugfix or new feature that you would like to contribute to @dhealth/hd-wallets, please find or open an issue 
...
You will need to fork the main @dhealth/hd-wallets code repository and clone 
...
Then sit back and wait. There will probably be discussion about the pull request and, if any changes are needed, we would love to work with you to get your pull request merged into @dhealth/hd-wallets.
...
[github-issues]:https://github.com/dhealthproject/dhealth-hd-wallets/issues